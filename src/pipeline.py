...
Браузерная сессия (Google Maps; до 29.08.2026 — ещё и 2ГИС, который теперь ходит
обычными HTTP-запросами через curl_cffi, см. src/scrapers/gis2.py) при этом
открывается ОДИН раз на весь
